...
// Implementacija pokretanja dodatne niti koja treba da
// pronađe reč suprotnog značenja (koristeći funkciju "nadjiAntonim")
//
...
string izracunaj(map<string, string> recnik, string rec)
{
    ...
    nit=thread(nadjiAntonim,ref(recnik),rec,ref(rezultat));
    nit.join();
